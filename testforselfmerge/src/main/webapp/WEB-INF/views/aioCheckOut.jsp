...
<section class="menu">
	...
	<section class="empty-cart page-wrapper">
		<div class="container">
			<div class="row">
			<h2 class="text-center">請選擇支付選項</h2>		
				<div class="col-md-6 col-md-offset-3">
					<div class="block text-center">
							
<a href="<spring:url value='aioCheckOut/aioCheckOutCVS' />"  class="btn btn-small btn-solid-border">超商代碼</a>
<a href="<spring:url value='/aioCheckOut/aioCheckOutOneTime' />"  class="btn btn-small btn-solid-border">信用卡一次付清</a>
<a href="<spring:url value='/aioCheckOut/aioCheckOutOneTime' />"  class="btn btn-small btn-solid-border">網路ATM</a>
<br>
<a href="<spring:url value='/products' />" class="btn btn-main mt-20">取消付款</a>			
