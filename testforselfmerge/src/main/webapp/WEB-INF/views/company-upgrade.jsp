...
<!-- 						            <text id=""> -->
<!-- 						                <tspan x="108.94" y="323">AVIATO</tspan> -->
<!-- 						            </text> -->
<!-- 						        </g> -->
<!-- 						    </g> -->
<!-- 						</svg> -->
...
<%-- 	             <span class="mr-2 d-none d-lg-inline text-gray-600 small"> ${company.memberid}</span> --%>
<!--                 <img class="img-profile rounded-circle" src="" height="50" > -->
