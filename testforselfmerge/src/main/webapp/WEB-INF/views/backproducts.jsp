					...
					<c:forEach var='product' items='${products}'>
						<div class="col-sm-6 col-md-3" style="width: 360px; height: 360px">
							<div class="thumbnail" style="width: 320px; height: 340px">
								<img style="width: 100px; height: 118px"
								...
								<div class="caption">
									...
									<p style='font-size: 15px;'>
										<b>廠牌&nbsp;:</b>&nbsp;&nbsp;${product.category}&nbsp;&nbsp;&nbsp;<b>顏色&nbsp;:</b>&nbsp;&nbsp;${product.color}
									</p>
									<p style='font-size: 15px;'>
										<b>庫存&nbsp;:</b>&nbsp;&nbsp;${product.stock}&nbsp;&nbsp;&nbsp;<b>容量&nbsp;:</b>&nbsp;&nbsp;${product.ram}

									</p>
									<p style='font-size: 18px;'>
										<b>販售價格&nbsp;:&nbsp;${product.price}&nbsp;&nbsp;&nbsp;</b>
									</p>
									<p>
										<a
											href="<spring:url value='/backproduct?id=${product.productId}' />"
											class="btn btn-primary"> <span
											class="glyphicon-info-sigh glyphicon"></span>商品資料
										</a>
										<!--										 <a -->
										<%-- 											href="<spring:url value='/cellphone?id=${product.productId}' />" --%>
										<!-- 											class="btn btn-primary"> <span -->
										<!-- 											class="glyphicon-info-sigh glyphicon"></span>新增補充規格 -->
										<!-- 										</a> -->
										<!-- 									</p> -->
										<!-- 									<p> -->
										<a
										...
										<!-- 										</a>  -->
										<a
											href="<spring:url value='/delete?id=${product.productId}' />"
