      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          <a class="logo" href="index.html">
            <img src="images/login.gif" alt="" width="200" height="auto">
          </a>
          <h2 class="text-center">請輸入帳號密碼</h2>
          <form class="text-left clearfix" action="/login" >
            <div class="form-group">
            	<label for="text" class="col-sm-3 control-label">帳號</label>
            	<input type="text" class="form-control" name="username" required pattern="^[a-zA-Z0-9]{6,8}$">
            </div>
            <div class="form-group">
            	<label for="text" class="col-sm-3 control-label">密碼</label>
          ...
          <p class="mt-20">第一次造訪本網站 ?<a href="<c:url value='/signin'/>"> 新建用戶</a></p>
