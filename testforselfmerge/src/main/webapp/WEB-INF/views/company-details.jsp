  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index2">
        ...
        <div class="sidebar-brand-text mx-3">EEIT後台 <sup>2</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">購買廣告</a>
            <a class="collapse-item" href="utilities-border.html">曝光商品</a>
...
<!-- </form> -->
      ...
      <jsp:include page="company-details2.jsp"></jsp:include> 
        
        
        
<!--       <div style="border: 1px solid red;margin:20px" > -->
<%--               <li><span>id:</span>${company.memberid}</li> --%>
<%--                 <li><span>姓名:</span>${company.username}</li> --%>
<%--                 <li><span>密碼:</span>${company.password}</li> --%>
<%--                 <li><span>信箱:</span>${company.email}</li> --%>
<%--                 <li><span>手機:</span>${company.phone}</li> --%>
<%--                 <li><span>地址:</span>${company.address}</li> --%>
<%--                 <li><span>統一編號:</span>${company.ein}</li> --%>
<%--                 <li><span>公司名稱:</span>${company.companyname}</li> --%>
<%--                 <li><span>公司電話:</span>${company.companytel}</li> --%>
<!--                 </div> -->
<!--     </div> -->
        <!-- Begin Page Content -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="index2">Logout</a>
        </div>
      </div>
    </div>
  </div>
