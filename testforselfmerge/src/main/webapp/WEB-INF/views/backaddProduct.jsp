...
<body id="page-top">
	...
	<div id="wrapper">
			...
			<div id="content">
				...
				<nav
					...
					<ul class="navbar-nav ml-auto">
						<input type="button" name="" value="上架" onClick="ok1()"
					...
					<form:form method='POST' modelAttribute="productBean"
						...
						<div class="row">
								...
								<fieldset>
									...
									<div class="form-group">
										<label class='control-label col-lg-2 col-lg-2' for="author">
											內文:</label>
										<div class='col-lg-10'>
											<textarea name="author" id="author" Cols="25" Rows="5"
												class="enjoy-css" onKeyUp="javascript:checkWord(this);"
							...
							<div class="col-sm-4" style="text-align: center">
								<fieldset>
									...
									<div class="form-group">
										<label class="control-label col-lg-2 col-lg-2" for='CPU'>CPU核心</label>
										<div class="col-lg-10">
							...
							<div class="col-sm-4" style="text-align: center">
								<fieldset>
									...
									<div class="form-group">
										...
										</label> <label for="productImage5"> <form:input type="file" accept="image/*"
												path="productImage5" name="productImage5" id="productImage5"
												onchange="productImage5" style="display: none;" /> <img
											id="productImage11"
											style="background-color: white; margin: 20px; height: 100px; width: 100px"
											src="images/add5.png" />
						...
						<div style="text-align: center">
							<input id="btnAdd" type='submit' class='btn btn-primary'
								value="新增商品" style="width: 140px; height: 50px" />
						</div>
					</form:form>
				</section>
		...
		<script>
			...
			function ok1() {
				$("#title").val("IPHONE XR 限量10台");
				$("#category").val("Apple");
				$("#modelid").val("iPhoneXR");
				$("#weight").val("177");
				$("#color").val("white");
				$("#CPU").val("4");
				$("#rom").val("4 GB");
				...
				$("#stock").val("10");
				$("#author").val(
						"iPhone屬特殊商品, 台灣蘋果公司貨,有原廠保固一年 全台蘋果授權維修中心都可以送修 歡迎購買");
				$("#brand").val("https://www.youtube.com/embed/qfZz1DC051E");
			}
